...
function ListProduct()
{
    ...
    $.get('/Product/List/'+ ShopID +'/'+ CategoryID +'/'+ VendorID +'/'+ DateFrom +'/'+ DateTo, function(data)
    {
     ...
     /* for(i=0;i<k.length;i++)
      ...
      if(shop>=0)
      {
        $('#fad').append('<input type="submit" name="submitBarCode" id="BarCodeButton" value="Generate QR Code"  class="btn btn-flat btn-lg btn-block bg-purple">').hide().delay(500).fadeIn(200);
