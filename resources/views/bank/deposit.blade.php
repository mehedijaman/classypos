    ...
    <section class="content">
      <div class="col-md-8 col-sm-8 col-lg-8 col-xs-12 col-md-offset-2 col-sm-offset-2 col-lg-offset-2">
        <div class="box box-primary">
          ...
          <div class="box-body">
            {{ Form::open(array('url' => '/Bank/Deposit/New', 'class' => 'form-horizontal'))}}
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 ">
                  <input name="TxBy" type="text" class="form-control" placeholder="Deposit by">
                </div>                                  
              </div>
              ...
              <div class="form-group">
                <div class="col-md-8 col-sm-8 col-lg-8 ">
                  <input class="btn btn-primary btn-flat" type="submit" name="Submit" value="Add Deposit">
