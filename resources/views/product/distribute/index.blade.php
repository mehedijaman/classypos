...
@section('content')
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <i class="fa fa-share"></i> Product Distribute
          <small> | Distribute products to shop</small>
        </h1>
        <ol class="breadcrumb">
      ...
      <section class="content">
        <div class="box box-primary ">
          <div class="box-header with-border"> <h3 class="box-title"><i class="fa fa-share"></i> Distribute Products</h3> </div>
              ...
              <div class="form-group">
                <div class="col-sm-3">
                  <div class="input-group">
                    <span class="input-group-addon bg-blue">Category :</span>
                ...
                <div class="col-sm-3">
                  <div class="input-group">
                    <span class="input-group-addon bg-blue">Vendor :</span>
            ...
            <div class="row">
              <div class="col-md-6">
                <div id="SelectAllArea">
                  ...
                  <input type="button" id="Shop" class="btn btn-primary btn-flat" value="Select Shop">
                  <span id="ShopEdit"> </span>                  
                </div>
              </div>
            </div>
