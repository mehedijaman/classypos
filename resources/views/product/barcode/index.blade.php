  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Generate &amp; print Barcode </small>
      </h1>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary">  
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-print"></i> Barcode Generation</h3>
          ...
          <div class="box-body">
            ...
            {{ Form::open(array('url' => '/Product/Barcode/Print', 'onsubmit' => "window.open('','ProductBarcode','width=+screen.width,height=+screen.height,scrollbars=yes,fullscreen=yes')", 'target'=>"ProductBarcode", 'class' => 'form-horizontal', 'method' => 'post')) }}
